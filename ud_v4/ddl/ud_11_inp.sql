...
rg_id varchar(16)   NOT NULL PRIMARY KEY,
...
CREATE TABLE epa_cat_hydrology (
...
aquif_id varchar(16) DEFAULT nextval ('SCHEMA_NAME.inp_aquifer_seq'::regclass) NOT NULL PRIMARY KEY,
por numeric(12,4),
wp numeric(12,4),
fc numeric(12,4),
k numeric(12,4),
...
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_backdrop_seq'::regclass) NOT NULL PRIMARY KEY,
text varchar(254)  
);
...
c3 numeric(12,4),
perunit varchar(10),
CONSTRAINT inp_buildup_land_x_pol PRIMARY KEY (landus_id, poll_id);
);
...
epa_subcatchment_id integer ,
landus_id varchar(16) ,
percent numeric(12,4)
CONSTRAINT inp_coverage_land_x_subc PRIMARY KEY (epa_subcatchment_id , landus_id)
);


CREATE TABLE inp_curve (
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_curve_seq'::regclass) NOT NULL PRIMARY KEY,
curve_id varchar(16)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_dwf_seq'::regclass) NOT NULL PRIMARY KEY,
inv_id integer,  ,
value numeric(12,7),
pat1 varchar(16)  ,
pat2 varchar(16)  ,
...
pat3 varchar(16)  ,
pat4 varchar(16) ,
CONSTRAINT inp_dwf_pol_x_node PRIMARY KEY (poll_id, inv_id);
);


CREATE TABLE inp_evaporation (
evap_type varchar(16) PRIMARY KEY,
evap numeric(12,4),
timser_id varchar(16)  ,
value_1 numeric(12,4),
value_2 numeric(12,4),
...
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_files_seq'::regclass) NOT NULL PRIMARY KEY,
...
CONSTRAINT inp_groundwater PRIMARY KEY (epa_subcatchment_id, aquif_id)
);


CREATE TABLE inp_hydrograph (
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_hydrograph_seq'::regclass) NOT NULL PRIMARY KEY,
text varchar(254)  
);


CREATE TABLE inp_inflows (
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_inflows_seq'::regclass) NOT NULL PRIMARY KEY,
inv_id integer,  ,
timser_id varchar(16)  ,
...
base numeric(12,4),
pattern_id varchar(16),
CONSTRAINT inp_inflows_pol_x_node PRIMARY KEY (poll_id, node_id)
);
...
landus_id varchar(16)   NOT NULL PRIMARY KEY,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_lid_control_seq'::regclass) NOT NULL PRIMARY KEY,
lidco_id varchar(16)  ,
...
epa_subcatchment_id integer NOT NULL,
...
toperv int2,
rptfile varchar(10)  
CONSTRAINT inp_lidusage_subc_x_lidco PRIMARY KEY (epa_subcatchment_id, lidco_id)
);
...
CONSTRAINT inp_loadings_pol_x_subc PRIMARY KEY (poll_id, epa_subcatchment_id)
);


CREATE TABLE inp_mapdim (
type_dim varchar(18)  PRIMARY KEY,
x1 numeric(18,6),
y1 numeric(18,6),
x2 numeric(18,6),
y2 numeric(18,6)
...
type_units varchar(18)  PRIMARY KEY,
map_type varchar(18)  
);
...
arc_inv_id integer PRIMARY KEY,
node_inv_id integer ,
ori_type varchar(18)  ,
offset numeric(12,4),
cd numeric(12,4),
...
arc_inv_id varchar(16) PRIMARY KEY,
node_inv_id varchar(16)  ,
curve_id varchar(16)  ,
to_arc_inv_id varchar(16)  ,
status varchar(3)  ,
...
stemp numeric(12,4) PRIMARY KEY,
atiwt numeric(12,4),
rnm numeric(12,4),
elev numeric(12,4),
lat numeric(12,4),
...
snow_id varchar(16) PRIMARY KEY,
cmin_1 numeric(12,4),
cmax_1 numeric(12,4),
...
temp_type varchar(16) PRIMARY KEY,
timser_id varchar(16)  ,
fname varchar(254)  ,
start varchar(12)  
);
...
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_timeseries_seq'::regclass) NOT NULL PRIMARY KEY,
timser_id varchar(16)  ,
date varchar(12)  ,
hour varchar(10)  ,
time varchar(10)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.inp_transects_seq'::regclass) NOT NULL PRIMARY KEY,
tsect_id varchar(16),
text varchar(254)  
);
...
CONSTRAINT inp_treatment_node_x_pol PRIMARY KEY (inv_id)
);
...
CONSTRAINT inp_washoff_land_x_pol PRIMARY KEY (landus_id, poll_id);
);
...
wind_type varchar(16) PRIMARY KEY,
value_1 numeric(12,4),
value_2 numeric(12,4),
value_3 numeric(12,4),
value_4 numeric(12,4),
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_arcflow_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
arc_id varchar(50)  ,
arc_type varchar(18)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_condsurcharge_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
arc_id varchar(50)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_continuity_errors_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
text varchar(255)  
);
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_critical_elements_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
text varchar(255)  
);
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_flowclass_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
arc_id varchar(50)  ,
length numeric(12,4),
dry numeric(12,4),
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_flowrouting_cont_seq'::regclass) NOT NULL PRIMARY KEY,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_groundwater_cont_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_high_conterrors_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
text varchar(255)  
);
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_high_flowinest_ind_seq'::regclass) NOT NULL PRIMARY KEY
result_id varchar(30)  ,
text varchar(255)  
);
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_instability_index_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
text varchar(255)  
);
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_lidperformance_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
epa_subcatchment_id integer 
lidco_id varchar(16)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_nodedepth_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
inv_id integer,  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_nodeflooding_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
inv_id integer,  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_nodeinflow_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
inv_id integer,  ,
swnod_type varchar(18)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_nodesurcharge_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
inv_id integer,  ,
swnod_type varchar(18)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_outfallflow_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
inv_id integer,  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_outfallload_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
poll_id varchar(16)  ,
inv_id integer,  ,
value numeric(12,4)
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_pumping_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
arc_id varchar(50)  ,
percent numeric(12,4),
num_startup int4,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_qualrouting_cont_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
poll_id varchar(16)  ,
dryw_inf numeric(12,4),
wetw_inf numeric(12,4),
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_rainfall_dep_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_cat_result_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)   NOT NULL,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_routing_timestep_seq'::regclass) NOT NULL PRIMARY KEY,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_runoff_qual_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
poll_id varchar(16)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_runoff_quant_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_storagevol_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
inv_id integer,  ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_subcatchwashoff_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)   NOT NULL,
epa_subcatchment_id integer  NOT NULL,
poll_id varchar(16)   NOT NULL,
value numeric
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_subcathrunoff_sum_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
epa_subcatchment_id integer   ,
...
id int4 DEFAULT nextval ('SCHEMA_NAME.rpt_timestep_critelem_seq'::regclass) NOT NULL PRIMARY KEY,
result_id varchar(30)  ,
text varchar(255)  
);
